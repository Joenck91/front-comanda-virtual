...
function updateFlavor(size) {
    ...
    document.querySelector('.flavor_four').style.display = (size === 'GIGANTE(4 sabores, 16 fatias, 40cm)' || size === 'KING(4 sabores, 20 fatias, 45cm)') ? 'flex' : 'none';//Se o tamanho for gigante e king: aparece o quarto sabor.
}
