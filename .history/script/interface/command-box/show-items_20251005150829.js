...
export default function showItems(notedOrder){
    ...
    notedOrder.pizzas.forEach((pizza, index) => {
        ...
        pizzaDiv.innerHTML = `
            ...
            <button class="remove-button" data-index="${index}" data-type="pizza">Remover Pizza</button>
        `;
    ...
    notedOrder.drinks.forEach((drink, index) => {
        ...
        drinkDiv.innerHTML = `
            ...
            <button class="remove-button" data-index="${index}" data-type="drink">Remover Bebida</button>
        `;
